...
export default class StitchUserFactoryImpl implements StitchUserFactory<StitchUser> {
    ...
    makeUser(id: string, loggedInProviderType: string, loggedInProviderName: string, isLoggedIn: boolean, lastAuthActivity: Date, userProfile: StitchUserProfileImpl, customData?: {
        [key: string]: any;
    }): StitchUser;
}
