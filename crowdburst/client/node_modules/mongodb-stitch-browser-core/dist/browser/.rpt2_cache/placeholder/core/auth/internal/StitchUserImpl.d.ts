...
export default class StitchUserImpl extends CoreStitchUserImpl implements StitchUser {
    ...
    constructor(id: string, loggedInProviderType: string, loggedInProviderName: string, isLoggedIn: boolean, lastAuthActivity: Date, profile: StitchUserProfileImpl, auth: StitchAuthImpl, customData?: {
        [key: string]: any;
    });
